...
**UPDATE: Lab 4.2 was submitted separately (albeit late) to illustrate the creation of a database API without the frontend. This submission (submitted on time) is still intended as fulfillment of Lab 4.3 - the frontend is not using the new Lab 4.2 REST API, however.)**
